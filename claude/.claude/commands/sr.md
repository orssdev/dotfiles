Push the current branch and open a pull/merge request against main, following the PR/MR style rules in CLAUDE.md.
...
5. Draft a title (`<type>(scope): message`, under 70 chars) and body (`## Summary` + `## Test plan` only) per CLAUDE.md.
